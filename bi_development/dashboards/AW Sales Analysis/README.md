...
-- описание модели данных, типа подключения, организация мер, фишки типа динамическое форматирование, закладки, svg-элементы

## Дизайн и визуальные решения

-- макет дашборда, цветовая палитра, шрифты